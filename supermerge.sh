...
git pull --no-ff --no-edit --quiet https://github.com/fredzamoabg/l10n-italy pull/5/head
...
git pull --no-ff --no-edit --quiet https://github.com/OCA/l10n-italy pull/2153/head
